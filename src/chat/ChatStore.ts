...
const useChatStore = create<ChatStore>((set) => ({
  chatRooms: [
    ...
    },
    {
      ...
      name: 'Chat Room',
      messages: [
        { user: '324324', content: 'Hello!', time: '12:00 PM' },
        { user: '324324', content: 'Hi!', time: '12:05 PM' },
        { user: '324324', content: '45ㅛㅅ5ㅅ54!', time: '12:05 PM' },
        { user: '324324', content: 'ㅗ소소!', time: '12:05 PM' },
        { user: '324324', content: 'Hi!', time: '12:05 PM' },
      ],

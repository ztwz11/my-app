  ...
  return (
    <div className="chat-app">
      <div className="container">
        <ChatList chatRooms={chatRooms} onSelectChatRoom={handleSelectChatRoom} onCreateChatRoom={handleCreateChatRoom} className="chat-list" />
        <div className="chat-content">
          ...
          <MemberList members={selectedChatRoom ? selectedChatRoom.members : []} className="member-list" />
        </div>
      </div>
    </div>
  );
